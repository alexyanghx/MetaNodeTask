...
// contract AuctionNFT is IERC721Receiver,CCIPReceiver{
//     struct Auction {
//         uint256 id;
//         uint256 minimumBid;
//         uint256 duration;
...
//         _admin = msg.sender;
//         _priceFeeds[address(0)] = AggregatorV3Interface(0x694AA1769357215DE4FAC081bf1f309aDC325306);
//         __CCIPReceiver_init_(router);
//     }
...
//         auction.ended = true;
//         IERC721 erc721 = IERC721(auction.tokenAddress);
...
//         require(hasPriceFeed(tokenAddress),"no price feed");
...
//     function hasPriceFeed(address tokenAddress) private view returns (bool){
...
//     function crossBid(address nftAddress, uint256 tokenId, uint256 amount, address tokenAddress) public payable{ 
